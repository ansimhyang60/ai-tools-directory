...
const UiGuidePage = lazy(() => import("./pages/GuidePages").then((module) => ({ default: module.UiGuidePage })));
const SkillsPage = lazy(() => import("./pages/GuidePages").then((module) => ({ default: module.SkillsPage })));
const PathPage = lazy(() => import("./pages/GuidePages").then((module) => ({ default: module.PathPage })));
const PrinciplesPage = lazy(() => import("./pages/GuidePages").then((module) => ({ default: module.PrinciplesPage })));
const ArchivePage = lazy(() => import("./pages/ArchivePage"));
function Router() {
  // make sure to consider if you need authentication for certain routes
  return <Suspense fallback={<div className="route-loading" role="status"><span>FIELD GUIDE / LOADING</span><strong>잠시만요, 화면을 펼치는 중입니다.</strong></div>}><Switch><Route path="/" component={Home} /><Route path="/workflows" component={WorkflowsPage} /><Route path="/tools" component={ToolsPage} /><Route path="/workflows/:id" component={WorkflowDetailPage} /><Route path="/ui-guide" component={UiGuidePage} /><Route path="/skills" component={SkillsPage} /><Route path="/path" component={PathPage} /><Route path="/principles" component={PrinciplesPage} /><Route path="/archive" component={ArchivePage} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch></Suspense>;
}
