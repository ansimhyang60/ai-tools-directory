...
export default function ArchivePage() {
  ...
  return <main className="site-shell inner-page archive-page">
    <header className="topbar"><Link className="brand" href="/"><span className="brand-stamp"><span className="stamp-slash">/</span><span className="stamp-main">{BRAND_MARK}</span><span className="stamp-caption">활용<br />가이드</span></span></Link><nav className="topnav"><Link href="/workflows">업무 찾기</Link><Link href="/tools">도구 찾기</Link><Link href="/skills">스킬 라이브러리</Link><Link className="active" href="/archive">기회·뉴스</Link></nav><MobileNav active="/archive" /><div className="top-actions"><span className="updated">{BRAND_NAME}</span><GlobalSearchTrigger /><Link className="back-home" href="/"><ArrowUpRight size={15} /> 홈</Link></div></header>
