  ...
  return (
    <main className="site-shell">
      <header className="topbar">
        <a className="brand" href="#top"><img className="brand-mark" src="/manus-storage/ai100-logo_d15b4e3d.png" alt="AI/100" /><span className="brand-stamp"><span className="stamp-slash">/</span><span className="stamp-main">AI<span>100</span></span><span className="stamp-caption">FIELD<br />GUIDE</span></span></a>
      ...
      <section className="hero" id="top">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><button className="primary-action" onClick={() => setDirectoryOpen(true)}>736+ 공개 카탈로그 펼치기 <ArrowUpRight size={17} /></button><span className="hero-note">필요할 때만 펼쳐서 검색하세요</span></div>
        </div>
        <div className="hero-art"><img src="/manus-storage/ai100-hero-atlas_475453fb.png" alt="AI 도구를 분류한 종이 아틀라스 일러스트" /><div className="hero-stamp"><strong>100</strong><span>AI tools<br />indexed</span></div></div>
      </section>
      ...
      <div className="content-layout" id="directory">
        <aside className="index-rail">
          ...
          <div className="rail-art"><img src="/manus-storage/ai100-catalog-map_40ed7bd1.png" alt="AI 도구 카테고리 연결 일러스트" /><span>FIND<br />YOUR<br />NEXT<br />MOVE</span></div>
        </aside>
        ...
        <section className="directory-panel">
          ...
          <button className="directory-toggle" onClick={() => setDirectoryOpen((value) => !value)} aria-expanded={directoryOpen}><span>{directoryOpen ? "공개 카탈로그 접기" : "공개 카탈로그 736+ 펼치기"}</span><span>{directoryOpen ? "−" : "+"}</span></button><div className={`directory-collapsible ${directoryOpen ? "is-open" : ""}`}>
