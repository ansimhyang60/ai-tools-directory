...
async function startServer() {
  ...
  app.get("/api/oauth/callback", (_req, res) => {
    res.type("html").send('<!doctype html><html lang="ko"><head><meta charset="utf-8"><title>AI/100 로그인</title></head><body><p>인증 결과를 확인하는 중입니다. <a href="/">홈으로 돌아가기</a></p></body></html>');
  });
